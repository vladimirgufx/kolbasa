...
from telethon.tl.types import InputPeerEmpty, Message, UserStatusOnline, UserStatusOffline, UserStatusRecently, \
    UserStatusLastWeek, UserStatusLastMonth
from telethon.tl.functions.users import GetUsersRequest

# ================= НАСТРОЙКИ =================
api_id = '34727495'  # Получить на my.telegram.org
api_hash = 'b842933ca587d85c2e74c9b643d4c9b6'  # Получить на my.telegram.org
phone = '+13515012543'  # Номер телефона аккаунта

TARGET_CHANNEL = 'https://t.me/flugerovsreal'  # Откуда берем людей для рассылки
...
# Аккаунт админа
ADMIN_USERNAME = '@PoizonMaxim'

# Лимиты
DELAY_BETWEEN_MESSAGES = 5 * 60  # 5 минут
MAX_DAILY_MESSAGES = 25

# НАСТРОЙКИ ФИЛЬТРАЦИИ
INCLUDE_RECENTLY = True  # Включать "недавно"
INCLUDE_LAST_WEEK = True  # Включать "на прошлой неделе"
